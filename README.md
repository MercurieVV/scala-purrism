...
```text
io.github.mercurievv:scala-purrism-scalafix_3:0.3.0
```
...
ThisBuild / scalafixDependencies +=
  "io.github.mercurievv" %% "scala-purrism-scalafix" % "0.3.0"
...
object app extends ScalaModule, ScalafixModule {
  ...
  def scalafixIvyDeps = Seq(
    mvn"io.github.mercurievv::scala-purrism-scalafix:0.3.0"
  )
}
```
...
```scala
//> using scalafix.dep io.github.mercurievv::scala-purrism-scalafix:0.3.0
```
