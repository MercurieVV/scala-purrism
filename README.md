...
```text
io.github.mercurievv:scala-purrism-scalafix_3:0.3.5
```
...
ThisBuild / scalafixDependencies +=
  "io.github.mercurievv" %% "scala-purrism-scalafix" % "0.3.5"
...
object app extends ScalaModule, ScalafixModule {
  ...
  def scalafixIvyDeps = Seq(
    mvn"io.github.mercurievv::scala-purrism-scalafix:0.3.5"
  )
}
```
...
```scala
//> using scalafix.dep io.github.mercurievv::scala-purrism-scalafix:0.3.5
```
