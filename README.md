...
```text
io.github.mercurievv:scala-purrism-scalafix_3:0.4.1
```
...
ThisBuild / scalafixDependencies +=
  "io.github.mercurievv" %% "scala-purrism-scalafix" % "0.4.1"
...
object app extends ScalaModule, ScalafixModule {
  ...
  def scalafixIvyDeps = Seq(
    mvn"io.github.mercurievv::scala-purrism-scalafix:0.4.1"
  )
}
```
...
```scala
//> using scalafix.dep io.github.mercurievv::scala-purrism-scalafix:0.4.1
```
